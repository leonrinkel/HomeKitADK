 ...
 * IID constants.
 */
#define kIID_BridgeAccessoryInformation                 ((uint64_t) 0x0001)
#define kIID_BridgeAccessoryInformationIdentify         ((uint64_t) 0x0002)
#define kIID_BridgeAccessoryInformationManufacturer     ((uint64_t) 0x0003)
#define kIID_BridgeAccessoryInformationModel            ((uint64_t) 0x0004)
#define kIID_BridgeAccessoryInformationName             ((uint64_t) 0x0005)
#define kIID_BridgeAccessoryInformationSerialNumber     ((uint64_t) 0x0006)
#define kIID_BridgeAccessoryInformationFirmwareRevision ((uint64_t) 0x0007)
#define kIID_BridgeAccessoryInformationHardwareRevision ((uint64_t) 0x0008)
...
const HAPBoolCharacteristic bridgeAccessoryInformationIdentifyCharacteristic = {
    .format = kHAPCharacteristicFormat_Bool,
    .iid = kIID_BridgeAccessoryInformationIdentify,
...
const HAPStringCharacteristic bridgeAccessoryInformationManufacturerCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationManufacturer,
...
const HAPStringCharacteristic bridgeAccessoryInformationModelCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationModel,
...
const HAPStringCharacteristic bridgeAccessoryInformationNameCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationName,
...
const HAPStringCharacteristic bridgeAccessoryInformationSerialNumberCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationSerialNumber,
...
const HAPStringCharacteristic bridgeAccessoryInformationFirmwareRevisionCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationFirmwareRevision,
...
const HAPStringCharacteristic bridgeAccessoryInformationHardwareRevisionCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationHardwareRevision,
...
const HAPStringCharacteristic bridgeAccessoryInformationADKVersionCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_BridgeAccessoryInformationADKVersion,
...
const HAPService bridgeAccessoryInformationService = {
    .iid = kIID_BridgeAccessoryInformation,
    ...
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic* const[]) { &bridgeAccessoryInformationIdentifyCharacteristic,
                                                            &bridgeAccessoryInformationManufacturerCharacteristic,
                                                            &bridgeAccessoryInformationModelCharacteristic,
                                                            &bridgeAccessoryInformationNameCharacteristic,
                                                            &bridgeAccessoryInformationSerialNumberCharacteristic,
                                                            &bridgeAccessoryInformationFirmwareRevisionCharacteristic,
                                                            &bridgeAccessoryInformationHardwareRevisionCharacteristic,
                                                            &bridgeAccessoryInformationADKVersionCharacteristic,
                                                            NULL }
};

//----------------------------------------------------------------------------------------------------------------------

const HAPBoolCharacteristic lightBulbAccessoryInformationIdentifyCharacteristic = {
    .format = kHAPCharacteristicFormat_Bool,
    .iid = kIID_LightBulbAccessoryInformationIdentify,
    .characteristicType = &kHAPCharacteristicType_Identify,
    .debugDescription = kHAPCharacteristicDebugDescription_Identify,
    .manufacturerDescription = NULL,
    .properties = { .readable = false,
...
const HAPStringCharacteristic lightBulbAccessoryInformationManufacturerCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationManufacturer,
    .characteristicType = &kHAPCharacteristicType_Manufacturer,
    .debugDescription = kHAPCharacteristicDebugDescription_Manufacturer,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPStringCharacteristic lightBulbAccessoryInformationModelCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationModel,
    .characteristicType = &kHAPCharacteristicType_Model,
    .debugDescription = kHAPCharacteristicDebugDescription_Model,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPStringCharacteristic lightBulbAccessoryInformationNameCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationName,
    .characteristicType = &kHAPCharacteristicType_Name,
    .debugDescription = kHAPCharacteristicDebugDescription_Name,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPStringCharacteristic lightBulbAccessoryInformationSerialNumberCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationSerialNumber,
    .characteristicType = &kHAPCharacteristicType_SerialNumber,
    .debugDescription = kHAPCharacteristicDebugDescription_SerialNumber,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPStringCharacteristic lightBulbAccessoryInformationFirmwareRevisionCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationFirmwareRevision,
    .characteristicType = &kHAPCharacteristicType_FirmwareRevision,
    .debugDescription = kHAPCharacteristicDebugDescription_FirmwareRevision,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPStringCharacteristic lightBulbAccessoryInformationHardwareRevisionCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_LightBulbAccessoryInformationHardwareRevision,
    .characteristicType = &kHAPCharacteristicType_HardwareRevision,
    .debugDescription = kHAPCharacteristicDebugDescription_HardwareRevision,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
const HAPService lightBulbAccessoryInformationService = {
    ...
    .properties = { .primaryService = false, .hidden = false, .ble = { .supportsConfiguration = false } },
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic* const[]) { &lightBulbAccessoryInformationIdentifyCharacteristic,
                                                            &lightBulbAccessoryInformationManufacturerCharacteristic,
                                                            &lightBulbAccessoryInformationModelCharacteristic,
                                                            &lightBulbAccessoryInformationNameCharacteristic,
